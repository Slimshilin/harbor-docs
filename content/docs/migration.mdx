...
A detailed description of the differences between the two task formats is available [here](/docs/task-difference).
...
To understand the differences between the two task formats, see the [differences](/docs/task-difference) page.